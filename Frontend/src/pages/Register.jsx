      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-slate-900 flex-col justify-between p-12 overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg">
          <h1 className="text-4xl font-bold text-white mb-6 leading-tight">
            Join the elite team of cloud trainers.
          </h1>
          <p className="text-lg text-blue-100 leading-relaxed">
            Create an account to manage training batches, assign lab environments, and monitor student progress in real-time.
          </p>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 overflow-y-auto">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center lg:text-left">
            <h2 className="hidden lg:block text-3xl font-bold text-slate-900 tracking-tight mb-2">Create Account</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-5">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    value={formData.role}
                    onChange={handleChange}
                    className={`w-full pl-10 pr-4 py-3 rounded-xl border-2 transition-all outline-none bg-slate-50/50 appearance-none ${
                      errors.role 
                        ? 'border-red-200 bg-red-50 text-red-900 focus:border-red-500 focus:ring-4 focus:ring-red-500/10' 
                        : 'border-slate-200 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 focus:bg-white'
                    }`}
                  >
              ...
              {formData.role === 'admin' && (
                <div className="animate-fadeIn space-y-1.5 p-4 bg-amber-50 rounded-xl border border-amber-100">
                  <label htmlFor="adminInviteCode" className="block text-sm font-bold text-amber-900">
                     Admin Invite Code
                  </label>
                  <input
                    type="text"
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 rounded-xl border-2 transition-all outline-none bg-white ${
                      errors.adminInviteCode 
                        ? 'border-red-200 bg-red-50 text-red-900 placeholder-red-400 focus:border-red-500 focus:ring-4 focus:ring-red-500/10' 
                        : 'border-amber-200 focus:border-amber-500 focus:ring-4 focus:ring-amber-500/10'
                    }`}
                  ...
                  <p className="text-xs text-amber-700 font-medium mt-1">
                    ⚠️ Required for admin verification
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="text-center pt-2">
              <p className="text-slate-600 font-medium">
                ...
                <Link to="/login" className="text-blue-600 hover:text-blue-700 font-bold hover:underline transition-colors ml-1">
                  Sign in
                </Link>
              </p>
            </div>
